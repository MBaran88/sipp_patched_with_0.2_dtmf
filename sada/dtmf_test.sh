...
## wait a few seconds, make a call with out-of-band DTMF-s (compliant with RFC 2833)
 # sleep 2
./sipp -i 192.168.20.204 10.10.10.149 -s 800 -sf sada/outband_dtmf_test_4_kris.xml -inf sada/dtmf_test.csv -l 3 -r 11 -m 3 -p 5075 -trace_err -trace_msg -trace_screen
# sleep 7
