...
## REGISTER
./sipp -i 192.168.20.204 10.10.10.136 -p 5064 -sf sada/dtmf_test_register.xml -inf sada/dtmf_test.csv -m 1 -r 1 -l 1 -trace_msg -trace_shortmsg -trace_err
 # sleep 1
...
## wait a few seconds, make a call with out-of-band DTMF-s (compliant with RFC 2833)
 # sleep 2
#  ./sipp -i 192.168.20.204 10.10.10.149 -s 800 -sf sada/outband_dtmf_test_4_kris.xml -inf sada/dtmf_test.csv -l 1 -r 11 -m 1 -p 5075 -trace_err -trace_msg -trace_screen
# sleep 7
