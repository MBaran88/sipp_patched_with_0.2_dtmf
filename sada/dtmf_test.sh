...
#################################################
cd /home/rafal/CLionProjects/sipp_patched_with_0.2_dtmf_good
# requires number 101 (caller) and working ivr 99100 (callee, test ivr)
## REGISTER
 ./sipp -i 192.168.21.61 10.10.10.149 -p 5064 -sf sada/dtmf_test_register.xml -inf sada/dtmf_test.csv -m 1 -r 1 -l 1 -trace_msg -trace_shortmsg -trace_err
 # sleep 1
...
## wait a few seconds, make a call with out-of-band DTMF-s (compliant with RFC 2833)
 # sleep 2
./sipp -i 192.168.21.61 10.10.10.149 -s 800 -sf sada/outband_dtmf_test_4_kris.xml -inf sada/dtmf_test.csv -l 400 -r 5 -m 800 -p 5075 -trace_err -trace_msg -trace_screen
# sleep 7
